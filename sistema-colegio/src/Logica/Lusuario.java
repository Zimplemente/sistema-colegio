...
//        Usuarios ousuarios = new Usuarios();
    ...
    public boolean insertarAlumno(Dusuario dts){
      ...
      try {
          ...
          pst.setString(15, dts.getPassusu());
  ...
  public boolean editarAlumno (Dusuario dts){
      sSQL="update usuario set apepatusu=?,apematusu=?,nomusu=?,edadusu=?,genusu=?,dirusu=?,emailusu=?,telfusu=?,estado=?,nickusu=?,passusu=?"
              + " where idusu=?";
      try {
          ...
          pst.setString(7, dts.getDirusu()); 
          pst.setString(8, dts.getEmailusu()); 
          pst.setString(9, dts.getTelfusu()); 
          pst.setString(10, dts.getEstado()); 
          pst.setString(11, dts.getNickusu()); 
          pst.setString(12, dts.getPassusu()); 
